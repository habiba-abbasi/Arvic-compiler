...
public class ICG {
     ...
     static ArrayList<Token> finalToken= Mylexer.finalToken;
     ...
     static String ivar;
      ...
      static String[] tem= new String[2];
     static String create_label(){
     return "L"+i++;
     }
                                            ...
                                            if(mc_body())
                                               {
                                                 if(finalToken.get(tokenindex).data.equals("}EndClass"))
                                                  {
//                                                     finalToken.get(tokenindex).data+="";
...
return false;
      ...
      if(finalToken.get(tokenindex).data.equals("trial"))
        {
            ...
            if(ID_Const_Sw())
                {
                    String id=finalToken.get(tokenindex).data;
                    T=create_temp();
                    generate(T+"="+temp+"=="+id);
                    generate("if("+T+" == FALSE)");
                    M1=create_label();
 ...
 static boolean trial_body(){
                        ...
                        if(M_st_f())
                        {
                            if(!p.matches("set")){M2=create_label();
                            tem[no]=M2;
                            generate("JMP "+tem[0]);
                            generate(M1+" :");
 ...
 static boolean Set_st(){
          ...
          if(finalToken.get(tokenindex).data.equals("set"))
            {
               p=finalToken.get(tokenindex).data;
                tokenindex++;
...
static boolean X1(){
    ...
    if(finalToken.get(tokenindex).type.name().equals("ID"))
{
    n1=finalToken.get(tokenindex).data;
...
static boolean Z(){
       ...
       if(finalToken.get(tokenindex).type.name().equals("ID"))
       {
           ivar=finalToken.get(tokenindex).data;
        tokenindex++;
          if(Z1())
          return true;
       }
       ...
       if(finalToken.get(tokenindex).data.equals(","))
        {
           tokenindex++;
           if(finalToken.get(tokenindex).type.name().equals("ID"))
            {   var2=finalToken.get(tokenindex).data;
               tokenindex++;
                 if(finalToken.get(tokenindex).type.name().equals("AssgnOp"))
                     {
                         tokenindex++;
                         ...
                         {
                             n2=finalToken.get(tokenindex).data;
                             generate(var2+ " = "+n2);
                             tokenindex++;
                                   if(list_cy1())
                                   {
    ...
    static boolean S_st_f()
     {
         ...
         else  if(finalToken.get(tokenindex).data.equals("whether")){  //if else
            //if else
           if(whether_Other()) 
           return true;
         }
